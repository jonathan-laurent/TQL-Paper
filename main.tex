...
%\author{Jonathan Laurent\inst{1}, Hector F Medina-Abarca\inst{2}, \and Jean Yang\inst{1,2}}
...
% TODO: generate CSV ?  What happens when Features of the
% implementation: types, coercions...  Give a reference to an appendix
% with the list of all functions and measures
